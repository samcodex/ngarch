...
import { SimpleDiagramElement } from '../simple-diagram-element';

const displayLengthMetadata = 50;

export class HierarchyElementBuilder implements ElementBuilder {
  constructor(
  ...
  convertToDiagramElement(): DiagramLinkableElement {
    ...
    const element: SimpleDiagramElement = new SimpleDiagramElement(elementType, this.archNgPonent);
